...
class RNN(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.rnn1 = torch.nn.GRU(in_chans,
                                 n_hidden_feat_per_layer, batch_first=True)
        self.rnn2 = torch.nn.GRU(n_hidden_feat_per_layer,
                                 n_hidden_feat_per_layer, batch_first=True)

        self.dropout1 = torch.nn.Dropout(drop_prob)
